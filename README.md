...
<sub>🧪 [Full example](examples/snippets/test/snippets/gherkin/gherkin_file.gleam) · 📖 [Guide](documentation/10-gherkin-bdd.md)</sub>
...
<sub>🧪 [Full example](examples/shopping_cart/test/features/shopping_cart.gleam) · 📖 [Guide](documentation/10-gherkin-bdd.md)</sub>
